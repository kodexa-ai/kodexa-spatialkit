...
def convert_azure_bbox(azure_obj, azure_page):
    ...
    bbox_points = azure_obj['boundingBox'] if 'boundingBox' in azure_obj.keys() \
        else azure_obj['bounding_box'] if 'bounding_box' in azure_obj.keys() else []
